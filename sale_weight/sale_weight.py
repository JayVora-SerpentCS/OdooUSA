...
class sale_order_line(models.Model):
    ...
    @api.one
    @api.depends('product_id', 'product_id.weight', 'product_uom_qty',
                 'product_uom', 'th_weight')
    ...
    weight_net = fields.Float(compute='_weight_net', readonly=True,
                              string='Net Weight', store=True,
                              help="The net weight")
