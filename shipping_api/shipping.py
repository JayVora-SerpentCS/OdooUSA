...
class shipping_move(models.Model):
    ...
    logis_company = fields.Many2one('res.company', string='Logistics Company', help='Name of the Logistics company providing the shipper services.')
    ...
    package_type =  fields.Selection([('', '')] , string='Package Type', help='Indicates the type of package')
    bill_shipping = fields.Selection([('shipper', 'Shipper'),('receiver', 'Receiver'),('thirdparty', 'Third Party')], 
    ...
    packages_ids =     fields.One2many("stock.packages", 'ship_move_id', string='Packages Table')
