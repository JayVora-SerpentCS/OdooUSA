...
class report_control_log_receipt_stock_packages(osv.AbstractModel):
    _name = 'report.shipping_ups.report_control_log_receipt_stock_packages'
    _inherit = 'report.abstract_report'
    _template = 'shipping_ups.report_control_log_receipt_stock_packages'
    _wrapped_report_class = report_print_control_log
