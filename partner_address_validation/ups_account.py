...
class ups_account(models.Model):
    ...
    accesslicensenumber =   fields.Char(string='AccessLicenseNumber', size=32, required=True, select=1)
    userid =                fields.Char(string='UserId',size=64 , required=True, select=1)
    ...
    url =                   fields.Char(string='Server',size=64 , default=lambda *a: 'wwwcie.ups.com', required=True, select=1)
