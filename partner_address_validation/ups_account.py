...
class ups_account(models.Model):
    '''
        UPS Account details
    '''
    _name = "ups.account"
    _rec_name = "accesslicensenumber"
    accesslicensenumber = fields.Char(string='AccessLicenseNumber', required=True, select=1)
    userid = fields.Char(string='UserId', required=True, select=1)
    password = fields.Char(string='Password', size=64, required=True, select=1)
    ups_active = fields.Boolean(string='Active', default=lambda *a: True)
    url = fields.Char(string='Server', default=lambda *a: 'wwwcie.ups.com', required=True, select=1)
    acc_no = fields.Char(string='Account Number',size=64 , required=True, select=1)
    max_lim_size = fields.Integer(string='Maximum List Size', required=True, default=lambda *a: 10)

    @api.model
    def _create_Address_Validation_Request_xml(self, data_for_Address_Validation_Request, data_for_Access_Request):
        ...
        # creating TransactionReference tag
        # XMLpath=AddressValidationRequest/Request/TransactionReference
        TransactionReference = doc.createElement("TransactionReference")
        Request.appendChild(TransactionReference)
        # creating CustomerContext tag
        # XMLpath=/AddressValidationRequest/Request/TransactionReference/CustomerContext
        ...
        # creating XpciVersion tag
        # XMLpath=AddressValidationRequest/Request/TransactionReference/XpciVersion
        ...
        # creating ToolVersion tag
        # XMLpath=AddressValidationRequest/Request/TransactionReference/ToolVersion
        ...
        # creating RequestAction tag
        # XMLpath=AddressValidationRequest/Request/RequestAction
        ...
        # creating RequestOption tag
        # XMLpath=AddressValidationRequest/Request/RequestOption
        ...
        # creating RequestOption tag
        # XMLpath=AddressValidationRequest/MaximumListSize
        ...
        # creating AddressKeyFormat tag
        # XMLpath=AddressValidationRequest/AddressKeyFormat
        AddressKeyFormat = doc.createElement("AddressKeyFormat")
        AddressValidationRequest.appendChild(AddressKeyFormat)
        # creating ConsigneeName tag
        # XMLpath=AddressValidationRequest/AddressKeyFormat/ConsigneeName
        ...
        # creating BuildingName tag
        # XMLpath=AddressValidationRequest/AddressKeyFormat/BuildingName
        ...
        # creating AddressLine tag
        # XMLpath=AddressValidationRequest/AddressKeyFormat/AddressLine
        ...
        AddressKeyFormat.appendChild(AddressLine)
        # creating Region tag
        # XMLpath=AddressValidationRequest/AddressKeyFormat/Region
        ...
        # creating PoliticalDivision2 tag
        # XMLpath=AddressValidationRequest/AddressKeyFormat/PoliticalDivision2
        ...
        # creating PoliticalDivision1 tag
        # XMLpath=AddressValidationRequest/AddressKeyFormat/PoliticalDivision1
        ...
        # creating PostcodePrimaryLow tag
        # XMLpath=AddressValidationRequest/AddressKeyFormat/PostcodePrimaryLow
        ...
        # creating PostcodeExtendedLow tag
        # XMLpath=AddressValidationRequest/AddressKeyFormat/PostcodeExtendedLow
        ...
        # creating PostcodeExtendedLow tag
        # XMLpath=AddressValidationRequest/AddressKeyFormat/Urbanization
        ...
        # creating CountryCode tag
        # XMLpath=AddressValidationRequest/AddressKeyFormat/CountryCode
    ...
    @api.model
    def _create_https_connecetion(self, UPS_SERVER, Request_string, UPS_url="/ups.app/xml/XAV", default_port=443):
        """Connects to the UPS server and returns the response as xml string """
        # creating http connection
        conn = httplib.HTTPSConnection(UPS_SERVER, default_port)

        if not conn:
            response_data = 'Connection failed'
        else:
            try:
                # requst being sent to ups
                conn.request("POST", UPS_url, Request_string)
    ...
    def address_validation(self, address_id):
        ...
        status = "True"
        error_msg = ""
        ups_ids = self.search([('ups_active', "=", True)])

        if ups_ids and address_id:
            ups_account = self.browse(ups_ids.id)
            ...
            Request_string = self._create_Address_Validation_Request_xml(data_for_Address_Validation_Request, data_for_Access_Request)
            response_string = self._create_https_connecetion(ups_account.url, Request_string)
            ...
            raise except_orm(_('Warning !'), _('Address validation is not set up.'))
            return []
